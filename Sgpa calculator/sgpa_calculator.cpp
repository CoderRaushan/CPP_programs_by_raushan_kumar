...
{
    int n;
    cout <<endl<< "press.1 for physics group with mentoring marks:"<<endl
         << "press.2 for physics group without mentoring marks:"<<endl
         << "press.3 for chemistry group with mentoring marks:"<<endl
